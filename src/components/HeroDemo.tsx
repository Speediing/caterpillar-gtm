  ...
  return (
    <>
      <div className="hero-copy">
        <p className="eyebrow">
          A proactive agent for every Caterpillar seller
        </p>
        <h1>The agents that work while your team sells.</h1>
        <p className="hero-intro">
          Grok Bot follows customer calls, watches for product and service
          questions, and researches public account signals in the background.
